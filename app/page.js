...
import { BarChart2, Book, Calendar, ChevronRight, FileText, Lock, Sparkle, Sparkles } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto text-center space-y-8">
        ...
        <div className="relative">
          ...
          <div className="bg-white rounded-2xl p-4 max-full mx-auto">
            <div className="border-b border-orange-100 pb-4 mb-4 flex items-center justify-center">
            ...
            <div className="space-y-4 p-4">
              <h3 className="text-xl font-semibold text-orange-900">{advice?advice:"My tought's today"}</h3>
